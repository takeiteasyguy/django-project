...
class SearchForm(forms.Form):
    q = forms.CharField(required=False, label=_('Поиск'),
...
class ModelSearchForm(SearchForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['models'] = forms.MultipleChoiceField(choices=model_choices(), required=False, label=_('Разделы поиска'), widget=forms.CheckboxSelectMultiple)
